...
const InternationalCollaborationElement = (props) =>
    props.targetInternationalCollaboration && props.targetInternationalCollaboration.internationalCollaboration ?
        <ListGroup horizontal={props.horizontal}>
            <ListGroup.Item variant={"primary"}>ID
            ...
            <ListGroup.Item>Entité partenaire
                : {props.targetInternationalCollaboration.internationalCollaboration.partnerEntity}</ListGroup.Item>

            <ListGroup.Item>date de début du projet
                : {props.targetInternationalCollaboration.internationalCollaboration.dateProjectStart}</ListGroup.Item>

            <ListGroup.Item>Les partenaires pi
                : {props.targetInternationalCollaboration.internationalCollaboration.piPartners}</ListGroup.Item>
            ...
            <ListGroup.Item>nombre Publications résultantes
                : {props.targetInternationalCollaboration.internationalCollaboration.numberResultingPublications}</ListGroup.Item>
